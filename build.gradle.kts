...
kotlin {
    ...
    swiftExport {
        moduleName = "Lru"
        flattenPackage = "io.github.kotlinmania.lru"
    }

    android {
        namespace = "io.github.kotlinmania.lru"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "lru-kotlin", version.toString())

    pom {
        name.set("lru-kotlin")
        description.set("Kotlin Multiplatform port of jeromefroe/lru-rs - A LRU cache implementation")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/lru-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/lru-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/lru-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/lru-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleLruXCFramework",
    "assembleLruDebugXCFramework",
    "assembleLruReleaseXCFramework",
    "assembleDebugIosFatFrameworkForLruXCFramework",
    "assembleReleaseIosFatFrameworkForLruXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForLruXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForLruXCFramework",
    "assembleDebugMacosFatFrameworkForLruXCFramework",
    "assembleReleaseMacosFatFrameworkForLruXCFramework",
    "assembleDebugTvosFatFrameworkForLruXCFramework",
    "assembleReleaseTvosFatFrameworkForLruXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForLruXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForLruXCFramework",
    "assembleDebugWatchosFatFrameworkForLruXCFramework",
    "assembleReleaseWatchosFatFrameworkForLruXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForLruXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForLruXCFramework",
