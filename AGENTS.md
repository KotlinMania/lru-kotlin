...
This file is the quick-reference operating contract for lru-kotlin. The longer
...
lru-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`lru`](https://crates.io/crates/lru). Upstream Rust is the behavioral oracle while the
